# not using this one anymore, but here as reference.
...
# well it should, but this isn't working.  so we'll use pin 16.
...
while 1:
	...
	log(nmeaFull)
        ...
        # iridium address, timestamp, latitude, N, longitude, W, altitude, M,temp,temp,pressure,cutdown
        # example:
        # RB0012851,142233.05,4633.000,N,11723.000,W,827.4,M,24.0,22.0,notCutdown
        try:
        ...
        packet += teensyString + ','
        if("cutdown" in teensyString):
            cutdown = True
        # cutdown by altitude is handled by Teensy
        '''
